...
public class mainFX extends Application {
    ...
    private static ReminderController reminderController; // Added field for reminderController
    ...
    public static void showChatbot() {
        loadFXML("/chatbot.fxml", "Assistant Pharmaceutique");
    }

    public static void showPharmacies() {
        loadFXML("/pharmacies.fxml", "Gestion des Pharmacies");
    }

    public static void showStatistiques() {
        loadFXML("/stats.fxml", "Statistiques des Médicaments et Matériels Médicaux");
    }

    public static void showGestionRappels() {
        try {
            FXMLLoader loader = new FXMLLoader(mainFX.class.getResource("/reminder.fxml"));
            Parent root = loader.load();

            // Store the ReminderController instance
            if (loader.getController() instanceof ReminderController) {
                reminderController = (ReminderController) loader.getController();
            }

            // Use configureStage to set up the scene and apply styles
            configureStage("Gestion des Rappels Médicaux", root);
        } catch (IOException e) {
            handleIOException(e); // Replaced handleLoadError with handleIOException
        }
    }
    ...
    public static void showListBlogView() {
        try {
            ...
            primaryStage.setScene(scene);
            primaryStage.show();
            primaryStage.setTitle("Blogs Médicaux");
        } catch (Exception e) {
