...
import tn.esprit.controllers.AddCommentaireController;
...
public class MainFx extends Application {
    ...
    public static void showAddCommentaireView(int blogId) {
        try {
            ...
            controller.setBlogId(blogId); // Passer l'ID du blog

            // Configurer la scène
            Scene scene = new Scene(root, 600, 400);
            primaryStage.setScene(scene);
            primaryStage.setTitle("Ajouter un commentaire");
            primaryStage.show();
        } catch (Exception e) {
            System.err.println("Erreur lors du chargement de addCommentaire.fxml:");
            e.printStackTrace();
