...
import tn.esprit.services.PharmaChatbotService; // Added import for PharmaChatbotService
...
public class Main {
    ...
    public static void menuChatbot(Scanner scanner) {
        System.out.println("\n=== ASSISTANT PHARMACEUTIQUE ===");
        System.out.println("Posez vos questions sur les médicaments (tapez 'exit' pour quitter)\n");
        ...
        while (true) {
            ...
            try {
                System.out.print("Pharmacien: ");
                String response = PharmaChatbotService.getPharmaResponse(question);
                System.out.println(response + "\n");
            } catch (Exception e) {
                System.out.println("Désolé, je ne peux pas répondre maintenant. Erreur: " + e.getMessage() + "\n");
            }
        }
    }
}
