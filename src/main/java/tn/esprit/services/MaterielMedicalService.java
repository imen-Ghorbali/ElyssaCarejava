...
public class MaterielMedicalService implements IMedicamentService<MaterielMedical> {
    ...
    // Ajout de la méthode pour récupérer le dernier matériel ajouté
    public MaterielMedical getLastAddedMateriel() {
        MaterielMedical materiel = null;
        String req = "SELECT * FROM materiel_medical ORDER BY id DESC LIMIT 1"; // Tri par ID décroissant pour obtenir le dernier ajouté
        ...
        try (Statement st = connection.createStatement();
            ...
            System.out.println("Erreur lors de la récupération du dernier matériel ajouté : " + e.getMessage());
        }
