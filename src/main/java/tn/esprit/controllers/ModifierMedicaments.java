...
public class ModifierMedicaments {
    ...
    public void setMedicament(Medicaments medicament) {
        ...
        if (medicament.getMaterielRequis() != null) {
            materielCombo.getSelectionModel().select(medicament.getMaterielRequis());
        }
    ...
    private void handleSave() {
        ...
        medicament.setMaterielRequis(materielCombo.getValue());
    ...
    private void redirectToAffichage() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AffichageMedicaments.fxml"));
